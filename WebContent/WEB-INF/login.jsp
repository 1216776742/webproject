    ...
    <td style="padding:30px"><div style="height:470px"><b>&nbsp;&nbsp;首页&nbsp;&raquo;&nbsp;个人用户登录</b>
          <div>
            <table width="85%" border="0" cellspacing="0">
              <tr>
                <td>
                	<form action="${pageContext.request.contextPath }/login.do?type=cate" method="post">
	               		 <div id="logindiv">
	                      ...
	                      <tr>
	                        <td style="text-align:center"><table width="80%" border="0" cellspacing="0" style="margin-top:15px ;margin-left:auto; margin-right:auto">
	                            <tr>
	                              ...
	                              <td style="text-align:left"><input name="uloginid" type="text" class="textinput" id="uloginid"/></td>
	                            </tr>
	                            <tr>
	                              <td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
	                              <td style="text-align:left"><input name="upassword" type="text" class="textinput" id="upassword" class="easyui-validatebox"/></td>
	                            </tr>
	                            <tr>
	                            ...
	                            <tr>
	                              <td colspan="2" style="padding-top:10px; text-align:center">
	                               <a href="${pageContext.request.contextPath }/dispacher.do?type=reg"><img name="image" src="${pageContext.request.contextPath }/images/signupbutton.gif" width="135" height="33"/></a></td>
	                            </tr>
	                        </table></td>
	                      </tr>
	                    </table>
                ...
                <td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
                  ...
                  <p style="text-align:right">
                    <a href="${pageContext.request.contextPath }/dispacher.do?type=reg"><img name="image" src="${pageContext.request.contextPath }/images/signupbutton.gif" width="135" height="33"/></a>
                  </p></td>
              </tr>
            </table>
          </div>
