...
<%-- <script src="${pageContext.request.contextPath }/js/checkForm.js" type="text/javascript" charset="utf-8"></script> --%>	
...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td><img src="${pageContext.request.contextPath }/images/check_use.gif" id="checkemail"/><span id="spemail"></span></td>
  </tr>
  <tr>
    <td style="text-align:right">会员名：</td>
    <td><input type="text" class="textinput" name="uname" id="uname"/></td>
    <td><img src="${pageContext.request.contextPath }/images/check_use.gif" id="checkuname"/><span id="sp"></span></td>
  </tr>
  <tr>
...
女</td>
  ...
  <tr>
    ...
    <td colspan="2"><input name="utel" type="text" class="textinput" id="ucode"/></td>
  </tr>
  <tr>
