    ...
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:70px">
      <tr>
        ...
        <td style="padding-top:30px"><font style="font-weight:bold; color:#FF0000">注册成功</font><br />
          ...
          <td style="padding-top:30px" ><a href="${pageContext.request.contextPath }/index.do" name="waittime">5秒后自动为您转跳回首页</a></td>
      </tr>
    </table>
    <script type="text/javascript">
        countDown(5,'${pageContext.request.contextPath }/index.do');
		function countDown(secs,surl){  
		var wait = document.getElementsByName("waittime");
		wait.innerHTML = secs;
		if(--secs>0){     
